    ...
    public partial class Admin : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            switch (result)
            {
                case DialogResult.Yes:
                    ...
                    eliminar(id, nombre, apellidos, usuario, pass, rol);
                    llenar();
        ...
        private void guardad(string nombres, string apellidos, string usuario, string pass, string rol)
        {
            ...
            try
            {
                ...
                string query = "INSERT INTO usuarios (nombres, apellido, usuario, pass, rol)" +
                    "values ('" + nombres + "','" + apellidos + "','" + usuario + "','" + pass + "', '" + rol + "');";
            ...
            else
            {
                ...
                switch (result)
                {
                    case DialogResult.Yes:
                        ...
                        guardad(nombre, apellidos, usuario, pass, rol);
                        llenar();
        ...
        private void gridDatos_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            GetUsuario(gridDatos, txtid, txtnombres, txtapellidos, txtusuario, txtcontraseña, rol);
        }
        ...
        private void update(string id, string nombres, string apellidos, string usuario, string pass, string rol)
        {
            ...
            try
            {
                ...
                string query = "UPDATE usuarios SET nombres = '" + nombres + "', apellido = '" + apellidos + "', usuario = '" + usuario + "', " +
        ...
        //boton que valida la nomina conforme el rol
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                nomina nomina = new nomina(id);
                nomina.Show();
                this.Hide();
            }
            else
            {
                MessageBox.Show("Solo los empleados tiene nomina");
            }
        }
    }
